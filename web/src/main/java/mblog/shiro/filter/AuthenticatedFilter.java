...
public class AuthenticatedFilter extends OncePerRequestFilter {
    ...
    private void identifyGuest(Subject subject, ServletRequest request, ServletResponse response, FilterChain chain)
            throws ServletException, IOException {
        redirectLogin(request, response);
    }

	private void redirectLogin(ServletRequest request, ServletResponse response) throws IOException {
